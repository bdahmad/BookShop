                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="col-1">Positive Review</th>
                            <th class="col-1">Neutral Review</th>
                            <th class="col-1">Negative Review</th>
                            <th class="col-1">Total Review</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        if ($numrow > 0) {
                            foreach ($details as $row1) :
                                ...
                                SUM(case when sentiment ='neutral vibe' then 1 else 0 end) as neutral,
                                SUM(case when sentiment ='negative' then 1 else 0 end) as negative
                                from review where bid = $row1->bid
                                ");
                                ...
                                foreach ($detail as $row) :
                                    ...
                                    if (!in_array($row1->bid, $match)) {
                                        ...
                                        $positiveSentiment = ($detail->positive/$row001->totalBid)*100;
                                        $nuetralSentiment = ($detail->neutral/$row001->totalBid)*100;
                                        $negativeSentiment = ($detail->negative/$row001->totalBid)*100;
                                        echo "
                                            <tr>
                                                <td class='col-1'>" . $row1->bid . "</td>
                                                <td class='col-3'>" . $pd->getName() . "</td>
                                                <td class='col-1'>" . round($positiveSentiment, 2).' %' . "</td>
                                                <td class='col-1'>" . round($nuetralSentiment, 2).' %' . "</td>
                                                <td class='col-1'>" . round($negativeSentiment, 2).' %' . "</td>
